...
async function submitContactFormWithEmailJS(formData) {
    try {
        ...
        const templateParams = {
            ...
            to_email: 'info@agric-empower.org', // Your receiving email
...
Hello,
    ...
    You have received a new message from your Agric-Empower website:
...
---
This message was sent from the contact form on agric-empower.org
*/